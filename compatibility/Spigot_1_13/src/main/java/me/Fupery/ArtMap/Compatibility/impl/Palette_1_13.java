...
public class Palette_1_13 implements Palette {
	public final ArtDye
	        ...
	        RED 				= new BasicDye(Lang.DYE_RED.get(), "RED", 4, ChatColor.RED, Material.ROSE_RED),
	        ...
	        YELLOW 				= new BasicDye(Lang.DYE_YELLOW.get(), "YELLOW", 18, ChatColor.YELLOW, Material.DANDELION_YELLOW),
	        ...
	        GREEN 				= new BasicDye(Lang.DYE_GREEN.get(), "GREEN", 27, ChatColor.DARK_GREEN, Material.CACTUS_GREEN),
