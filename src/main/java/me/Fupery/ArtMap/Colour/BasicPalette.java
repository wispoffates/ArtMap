...
public class BasicPalette implements Palette {
	public final ArtDye
	        ...
	        RED 		= new BasicDye(DYE_RED.get(), "RED", 4, ChatColor.RED, Material.RED_DYE),
	        ...
	        YELLOW 		= new BasicDye(DYE_YELLOW.get(), "YELLOW", 18, ChatColor.YELLOW, Material.YELLOW_DYE),
	        ...
	        GREEN 		= new BasicDye(DYE_GREEN.get(), "GREEN", 27, ChatColor.DARK_GREEN, Material.GREEN_DYE),
