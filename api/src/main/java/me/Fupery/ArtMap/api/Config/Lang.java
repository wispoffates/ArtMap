...
public enum Lang implements LangSet<String> {
    ...
    SAVE_SUCCESS, SAVE_FAILURE, DELETED, PREVIEWING, NEED_CANVAS, NO_CONSOLE, PLAYER_NOT_FOUND, NO_PERM, NOT_RIDING_EASEL, NOT_YOUR_EASEL, REPAIR_USAGE, ERROR_ON_EASEL,
